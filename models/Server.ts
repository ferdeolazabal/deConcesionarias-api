...
class Server {
  ...
  routes() {
    ...
    this.app.use(
      this.apiPaths.VehicleProperty,
      require("../routes/vehicleProperty")
    );
    this.app.use(
      this.apiPaths.PropertyCategories,
      require("../routes/propertyCategory")
    );
    this.app.use(
      this.apiPaths.PropertyValues,
      require("../routes/propertyValue")
    );
  }
